...
export default function CrewCreatePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                alert(`크루 홍보 작성 실패: ${errorData.error}`);
            } else {
                alert("크루 홍보가 성공적으로 생성되었습니다.");
                window.location.href = "/crew";
            }
        } catch (error) {
            console.error("크루 홍보 생성 중 오류 발생:", error);
            alert("크루 홍보 생성에 실패했습니다.");
        }
    };
    ...
    return (
        <div className="min-h-[calc(100vh-5rem-60px)] mt-20 grid z-10 px-4">
            <BoardWrapper>
                <div className="my-3 flex-center text-xl">크루 홍보</div>
